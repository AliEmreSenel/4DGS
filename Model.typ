...
#table(
  ...
  [*Section*], [*Specialisation*], [*Element*], [*Code*], [*Quality*], [*Memory*], [*Time*], [*Render*],

  table.cell(rowspan: 1)[#rotate(-90deg, reflow: true)[*0. Iter*]],
  [Schedule], [Number of Iterations], N([]), G([+]), N([]), R([-]), N([]),
  ...
  [Segmentation], [MegaSAM initialization], R([-]), G([+]), N([]), R([-]), N([]),
...
Spatio-Temporal], R([-]), G([+]), G([+]), G([+]), G([+]),
  ...
  [Thresholding], [Opacity Threshold], G([+]), R([-]), G([+]), G([+]), G([+]),
  [Loading], [Visibility Mask Loading], R([-]), N([]), G([+]), G([+]), G([+]),
)
