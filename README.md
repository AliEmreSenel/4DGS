...
| -------------------------------- | ----------------- | --------- | -------- | --------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Gaussians <br> 4D                | ✓                 | ✓         | ✓        | ✓         | ✓        | **Current-only mode.** [`GaussianModel.__init__`](scene/gaussian_model.py#L198-L244), [`training guard`](train.py#L630-L637), [`render guard`](gaussian_renderer/__init__.py#L159-L174)                                                                                                                                                                                                                         |
...
| Gaussians <br> Isotropic         |                   | ✓         |          |           |          | **Existing / adapted.** [`DEFAULT_ISOTROPY`](batch_train.py#L55-L58), [`GaussianModel` isotropic flag](scene/gaussian_model.py#L207-L231), [`get_scaling`](scene/gaussian_model.py#L357-L361), [`_apply_isotropic_parameterization`](scene/gaussian_model.py#L392-L412), [`Instant4D override`](batch_train.py#L1180-L1196)                                                                                     |
| Gaussians <br> Anisotropic       | ✓                 |           | ✓        | ✓         | ✓        | **Existing / default.** [`DEFAULT_ISOTROPY`](batch_train.py#L55-L58), [`get_scaling`](scene/gaussian_model.py#L357-L361), [`build_scaling_rotation`](utils/general_utils.py#L102-L111), [`build_scaling_rotation_4d`](utils/general_utils.py#L135-L145)                                                                                                                                                         |
| Gaussians <br> RGB               |                   | ✓         |          |           |          | **Existing / preset-driven.** [`RGB preset`](batch_train.py#L60-L63), [`RGB2SH`](utils/sh_utils.py#L225-L226), [`create_from_pcd`](scene/gaussian_model.py#L484-L555), [`Instant4D override`](batch_train.py#L1180-L1196)                                                                                                                                                                                       |
| Gaussians <br> SH(1)             |                   |           | ✓        |           |          | **Existing / MobileGS-style.** [`SH1 preset`](batch_train.py#L63-L69), [`_first_order_features`](utils/mobile_compression.py#L65-L84), [`MobileGS preset`](batch_train.py#L1222-L1231), [`capture_mobile_payload`](utils/mobile_compression.py#L241-L348)                                                                                                                                                       |
| Gaussians <br> SH(3)             | ✓                 |           |          | ✓         | ✓        | **Existing / native 4DGS appearance.** [`sh_degree = 3`](arguments/__init__.py#L54-L70), [`SH3 preset`](batch_train.py#L70-L73), [`get_max_sh_channels`](scene/gaussian_model.py#L436-L441), [`eval_shfs_4d`](utils/sh_utils.py#L115-L223)                                                                                                                                                                      |
...
| Compress <br> MLP / Distillation |                   |           | ✓        |           |          | **Implemented for MobileGS sort-free runs.** [`MobileOpacityPhiNN`](scene/gaussian_model.py#L85-L134), [`_load_mobilegs_teacher`](train.py#L132-L139), [`distillation setup`](train.py#L717-L729), [`distillation loss`](train.py#L931-L950), [`MobileGS preset`](batch_train.py#L1222-L1231)                                                                                                                   |
...
| Prune <br> Contribution          | ✓                 |           | ✓        |           |          | **Implemented.** [`render gaussian_scores`](gaussian_renderer/__init__.py#L521-L558), [`compute_spatio_temporal_variation_score`](scene/gaussian_model.py#L785-L852), [`generic_contribution_scores`](compression_postprocess.py#L495-L509), [`prune_generic_contribution`](compression_postprocess.py#L582-L610)                                                                                               |
...
| Prune <br> Spatio-Temporal       | ✓                 |           |          |           |          | **Re-implemented.** [`compute_spatio_temporal_variation_score`](scene/gaussian_model.py#L785-L852), [`prune_with_spatio_temporal_score`](scene/gaussian_model.py#L883-L965), [`scheduled ST pruning`](train.py#L1508-L1541)                                                                                                                                                                                     |
...
| Prune <br> One-shot              | ✓                 |           |          |           |          | **Implemented as pruning option.** [`final_prune_from_iter`](arguments/__init__.py#L121-L122), [`densify_then_prune_once registry`](batch_train.py#L962-L969), [`final ST prune`](train.py#L1594-L1617)                                                                                                                                                                                                         |
| Prune <br> Scheduled             | ✓                 |           |          |           |          | **Implemented as pruning option / paper preset.** [`interleaved_prune_densify registry`](batch_train.py#L970-L984), [`scheduled pruning loop`](train.py#L1508-L1541)                                                                                                                                                                                                                                            |
...
| Prune <br> Edge-guided Split     |                   |           |          | ✓         |          | **Re-implemented DropoutGS ESS-style split.** [`build_ess_registry`](batch_train.py#L102-L135), [`compute_edge_guided_split_mask`](train.py#L220-L293), [`split_points_by_mask`](scene/gaussian_model.py#L1156-L1247), [`ESS schedule`](train.py#L1551-L1592)                                                                                                                                                   |
| Prune <br> Dropout               |                   |           |          | ✓         |          | **Re-implemented DropoutGS RDR.** [`random_dropout_prob`](arguments/__init__.py#L91-L91), [`lambda_rdr`](arguments/__init__.py#L129-L134), [`build_dropout_registry`](batch_train.py#L87-L98), [`render dropout mask`](gaussian_renderer/__init__.py#L377-L399), [`RDR loss`](train.py#L957-L981)                                                                                                               |
...
| Render <br> Sort-free            |                   |           | ✓        |           |          | **Heavily modified MobileGS-style OIT path.** [`sort_free_render`](gaussian_renderer/__init__.py#L212-L247), [`MobileGS opacity/phi render`](gaussian_renderer/__init__.py#L472-L535), [`duplicateWithTileKeys`](diff-gaussian-rasterization-ms-nosorting/cuda_rasterizer/rasterizer_impl.cu#L127-L166), [`OIT kernels`](diff-gaussian-rasterization-ms-nosorting/cuda_rasterizer/rasterizer_impl.cu#L458-L929) |
